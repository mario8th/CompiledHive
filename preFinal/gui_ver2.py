...
class WidgetGallery(QtGui.QDialog):
    ...
    def getData(self):
        ...
        config.close()
        self.logInfo()
        print (dronesConnected, droneIDs, fpConnected, objectDict, visToggle, logToggle)
        return (dronesConnected, droneIDs, fpConnected, objectDict, visToggle, logToggle)
